...
\begin{document}
  ...
  %Einband
    ...
    \vspace*{\fill}
    \begin{Huge}
      { \color{kjgtuerkis}  Stand Juni 2017}
    \end{Huge}
    \vspace*{\fill}
    \newpage
  %Zitat Thoms Morus
...
\subsubsection{Zusammensetzun und Einberufung des Orga-Teams}
...
Sie führt den Namen „Katholische junge Gemeinde (KjG) Arbeitsgemeinschaft N.N.“. Das Ver-
bandszeichen ist der Seelenbohrer.

Vordringliche Aufgabe der Arbeitsgemeinschaft ist die Unterstützung, Förderung und Koordinie-
rung der Arbeit der KjG Pfarrgemeinschaften.
...
Die Satzung bedarf der Zustimmung der Diözesanleitung. Gegen die Entscheidung der Diözesan-
leitung kann beim Diözesanausschuss Einspruch erhoben werden. Der Diözesanausschuss ent-
scheidet abschließend. Zur Satzungsgebung ist die Diözesanleitung
anzuhören.
...
Die Organe des Diözesanverbandes sind die Diözesankonferenz, der Diözesanausschuss und die
Diözesanleitung.
\subsection{Die Diözesankonferenz}
Die Diözesankonferenz ist das oberste beschlussfassende Organ des Diözesanverbandes. Sie
trifft im Rahmen der Grundlagen und Ziele, sowie der Satzung des Bundesverbandes und der
Beschlüsse der Bundeskonferenz die grundlegenden Entscheidungen über die Arbeit des Diöze-
sanverbandes.
...
über die Arbeit und beschließt über laufende wichtige Angelegenheiten des Diözesanverbandes.
...
Das Mindestalter für den Diözesanausschuss liegt bei 16 Jahren. Von den stimmberechtigten Mit-
gliedern des Diözesanausschusses, die nicht Teil der Diözesanleitung sind, muss aber mindestens
...
dem Wegfall der Voraussetzung für den Diözesanausschuss erlischt die Mitgliedschaft im Diöze-
sanausschuss.
...
von der Diözesanleitung mindestens 14 Tage vorher einberufen. Den Vorsitz hat die Diözesanlei-
tung.
...
\begin{itemize}
  \item3 Diözesanleiterinnen, wovon eine Geistliche Leiterin 
       \footnote{
...
Zu einer Auflösungsversammlung des Diözesanverbandes muss mindestens 28 Tage vorher
