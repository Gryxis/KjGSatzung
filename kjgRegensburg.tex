...
\usepackage[normalem]{ulem} % Fuer Strikeout command zum bearbeiten
%------------------------------------------
%    Farben
%------------------------------------------
...
%--------------------------------------
% Commands zum Bearbeiten

\newcommand{\deleted}[1]{{\color{red}\sout{#1}}}
\newcommand{\added}[1]{{\color{green} #1}}
\newcommand{\diff}[1]{{\color{orange} #1}}
\newcommand{\todo}[1]{{\color{kjgtuerkis} #1}}
%--------------------------------------
...
\begin{document}
  ...
  \begin{titlepage}
  	\begin{center}
  		...
  		\Large Satzung\\
  		\vspace*{1.5cm}
  		\normalsize Zuletzt bearbeitet am \today\\
  		\vspace*{1.5cm}
  		\large Bearbeitung-kommandos:
  			\begin{itemize}
  				\item\deleted{Gelöscht (Antrag)}
  				\item\added{Hinzugefügt (Antrag)}
  				\item\diff{Differenz zur aktuell gültigen Satzung}
  				\item\todo{Todo für die Zukunft}
  			\end{itemize}
  ...
  %Einband
    ...
    \vspace*{\fill}
    \begin{Huge}
      { \color{kjgtuerkis}  Stand März 2022}
    \end{Huge}
    \vspace*{\fill}
    \newpage
  %Zitat Thoms Morus
...
\diff{Demokratisch und gleichberechtigt wählen alle Mitglieder altersunabhängig die Leitungen und
...
und gerechter Lebensbedingungen für \todo{alle Mädchen und Jungen, Frauen und Männer und an einer
...
\begin{itemize}
  \diff{\item Beratung und Beschlussfassung über}
    \begin{itemize}  
      \diff{\item die an die Mitgliederversammlung gerichteten Anträge}
...
\begin{itemize}
  ...
  \item Ein Mitglied des \deleted{Pfarrvorstandes}\added{Kreisvorstandes} des BDKJ
...
stimmberechtigten Mitglieder. \todo{Für den Ablauf der Mitgliederversammlung gilt im
  ...
  \item Wahl:
    \begin{itemize}
      ...
      \item der Delegierten der Mitgliederversammlung der KJG Landesstelle e.V., sofern die Diözesanleitung
            unbesetzt ist
      \item \todo{der Delegierten für die Landesversammlung und Landesausschüsse der Katholischen jungen Gemeinde Landesarbeitsgemeinschaft Bayern}
...
Diözesankonferenz mindestens drei Wochen vorher schriftlich\todo{, per Brief oder elektronisch,} mitgeteilt worden ist.
...
Von den Personen, die nicht zur Diözesanleitung gehören, sind bis zu zwei Personen unterschiedlichen Geschlechts Geistliche Leitung.\footnote{Das Amt der Geistlichen Leitung kann von Personen wahrgenommen werden, die
	eine theologische oder religionspädagogische Ausbildung abgeschlossen haben.
	Eine männliche Geistliche Leitung kann in Absprache mit dem bischöflichen Stuhl
	nur von ordinierten, katholischen Priestern wahrgenommen werden.}\\
...
\diff{Die Diözesanleitung führt die Geschäfte und vertritt den KjG Diözesanverband Regensburg in sämtlichen
Angelegenheiten gerichtlich und außergerichtlich. (\textit{Anmerkung [Tobi Preis]: Satz steht in der aktuell gültigen Fassung unter dem folgenden Punkt \glqq Aufgaben der Diözesanleitung\grqq})}
...
Von diesen Personen sind bis zu zwei Personen unterschiedlichen Geschlechts Geistliche Leitung.\footnote{Das Amt der Geistlichen Leitung kann von Personen wahrgenommen werden, die
	eine theologische oder religionspädagogische Ausbildung abgeschlossen haben.
	Eine männliche Geistliche Leitung kann in Absprache mit dem bischöflichen Stuhl
	nur von ordinierten, katholischen Priestern wahrgenommen werden.}
...
des Diözesanausschusses. \todo{Eine Vergütung für den Zeitaufwand nach Ausscheiden aus dem Amt der Diözesanleitung ist nicht mehr möglich. (\textit{Anmerkung [Tobi Preis]: Vorschlag zum sichergehen, dass nach langjährigem Ausscheiden nicht plötzlich unerwartete finanzielle Anforderungen kommen.})}
...
und gewähltem Diözesanausschuss \todo{(\textit{Anmerkung [Tobi Preis]: sollte dann dies nicht auch in die Aufgaben des Diözesanausschusses aufgenommen werden?})}. Bei Bedarf können weitere interessierte KjG Mitglieder,
...
Zwecke fällt das Vermögen des Diözesanverbandes an den \diff{ KjG Bundesverband, der es unmittelbar und
...
\added{Die Neufassung der Satzung tritt nach ihrer Beschlussfassung durch die kleine Diözesankonferenz der Katholischen jungen Gemeinde Diözesanverband Regensburg 2022 und nach Zustimmung durch die Bundesleitung der KjG in Kraft. (\textit{Anmerkung [Tobi Preis]: das was hier zuvor stand war vermutlich ein copy-paste-Fehler. Das hier ist bereits in der aktuellsten beschlossenen Fassung.})}
...
\subsection*{§1 Termin \added{und Tagungsform}}
Der Termin der jährlichen Diözesankonferenz wird von der Diözesankonferenz beschlossen.
\added{Die Diözesankonferenz kann auf allgemeinen oder einzelfallbezogenen Beschluss auch in Form einer Video- oder Telefonkonferenz tagen. Mischformen sind zulässig.
Der Beschluss zum Tagen in einer Video- oder Telefonkonferenz wird für die Diözesankonferenz einzelfallbezogen durch die Diözesankonferenz selbst oder den Diözesanausschuss getroffen.}
...
\subsection*{§1 Termin}
Der Termin der jährlichen Mitgliederversammlung wird von der Mitgliederversammlung beschlossen. \added{Die Mitgliederversammlung kann auf allgemeinen oder einzelfallbezogenen Beschluss auch in Form einer Video- oder Telefonkonferenz tagen. Mischformen sind zulässig. Der Beschluss zum Tagen in einer Video- oder Telefonkonferenz wird für die Mitgliederversammlung einzelfallbezogen durch die Mitgliederversammlung selbst oder die pädagogische Leitungsrunde getroffen.}
\subsection*{§2 Vorbereitung}
